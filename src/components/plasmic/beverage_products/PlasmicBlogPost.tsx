...
import sty from "./PlasmicBlogPost.module.css"; // plasmic-import: JuwEOmGERcqq/css

import b12W2LZn4VyAc from "./images/b1.jpg"; // plasmic-import: 2W2lZN4vy-ac/picture
...
function PlasmicBlogPost__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__ojHDi, {
          [sty.freeBoxlong__ojHDiMwcAg]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
          defaultContents: (
            <PlasmicImg__
              alt={""}
              className={classNames(sty.img__avAbV)}
              displayHeight={"auto"}
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__n5HyM, {
          [sty.freeBoxlong__n5HyMMwcAg]: hasVariant($state, "long", "long")
        })}
      >
        {renderPlasmicSlot({
