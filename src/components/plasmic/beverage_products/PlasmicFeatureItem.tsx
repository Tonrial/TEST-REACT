...
import sty from "./PlasmicFeatureItem.module.css"; // plasmic-import: No0fu08c8RY0/css
...
function PlasmicFeatureItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__sZxXw)}>
        <div className={classNames(projectcss.all, sty.freeBox__xsXzm)} />

        <div className={classNames(projectcss.all, sty.freeBox__got9Y)}>
          <Stack__
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox___07IMc)}
          >
            <div
              className={classNames(
                projectcss.all,
            ...
            <div className={classNames(projectcss.all, sty.freeBox__p42Ds)}>
              <div
                className={classNames(
                  projectcss.all,
                  projectcss.__wab_text,
            ...
            <Stack__
              as={"div"}
              hasGap={true}
              className={classNames(projectcss.all, sty.freeBox__i1HEa)}
            >
              <LinkButton
