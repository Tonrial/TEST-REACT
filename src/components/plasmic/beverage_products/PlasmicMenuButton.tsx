...
import sty from "./PlasmicMenuButton.module.css"; // plasmic-import: R0iXjF82QZwu/css

import BarsIcon from "./icons/PlasmicIcon__Bars"; // plasmic-import: IyWDxcEYPghl/icon
import TimesIcon from "./icons/PlasmicIcon__Times"; // plasmic-import: aPEnX6566dvp/icon
...
function PlasmicMenuButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      >
        <BarsIcon
          className={classNames(projectcss.all, sty.svg__eyj21, {
            [sty.svgexpanded__eyj21Heb37]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
        ...
        <TimesIcon
          className={classNames(projectcss.all, sty.svg__quyJy, {
            [sty.svgexpanded__quyJyHeb37]: hasVariant(
              $state,
              "expanded",
              "expanded"
            )
